...
var app = {
  ...
  products : [
      {
        "name" : "Suit",
        "price" : "119.95",
        "img" : "http://images.askmen.com/fashion/apparel/1243535374_jcrew-ludlow-suit_3.jpg",
        "desc" : "Slim fit design"
      },
      // {
      //   "name" : "Tap Water",
      //   "price" : "0.99",
      ...
      //   "desc" : "Always stay up-to-date!"
      // },
      {
        "name" : "Waist Coat",
        "price" : "40.00",
        "img" : "http://besottedclothing.co.uk/media/catalog/product/cache/1/thumbnail/9df78eab33525d08d6e5fb8d27136e95/_/c/_check_zip_up_slunky_waistcoat_grey_1a.jpg",
        "desc" : "Sophisticated waist coat design"
      }
    ],
  ...
  updateTotals: function () {
    ...
    $("#clonetotalCtr").find(".cart-totals-value").html( subtotal.to_$() );
    // $("#taxesCtr").find(".cart-totals-value").html( (subtotal * 0.13).to_$() );
    // $("#totalCtr").find(".cart-totals-value").html( (subtotal * 1.13 + shipping).to_$() );
